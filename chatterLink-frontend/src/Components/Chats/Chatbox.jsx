...
// Chat bubble SVG for empty state
const ChatIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.2} stroke="#E9E9E7" style={{ width: 48, height: 48, marginBottom: 8 }}>
